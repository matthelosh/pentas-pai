...
const ImportSekolah = defineAsyncComponent(() =>
    import("@/Components/Sekolah/ImportSekolah.vue")
);
// Impor
...
<template>
    ...
    <Dash title="Data Sekolah">
        <div
            class="container w-full bg-white my-4 md:mt-0 rounded-xl overflow-hidden mx-auto"
        >
            <div
                class="toolbar w-full h-12 flex items-center justify-between p-3 sticky top-0 bg-white shadow"
            >
                <span>
                ...
                <div class="toolbar-items flex items-center gap-2">
                    ...
                    />
                    <button
                        class="py-1 px-2 bg-teal-600 flex items-center text-white rounded hover:bg-teal-800 active:bg-orange-600"
                        @click="$refs.fileSekolah.click()"
                    >
                        <SvgIcon
                            type="mdi"
                            :path="mdiFileExcelBox"
                    ...
                    >
                        <thead>
                            <tr class="bg-teal-200">
                                ...
                                <th class="p-3 border-e border-gray-600">
                                    NPSN
                                </th>
                                <th class="p-3 border-e border-gray-600">
                                    Nama
                        ...
                        <tbody>
                            ...
                            >
                                <td
                                    class="text-center py-1 px-2 border-e border-gray-600"
                                >
                                    {{ s + 1 }}
                                </td>
                                <td
                                ...
                                <td class="py-1 px-2 border-e border-gray-600">
                                    {{ sekolah.nama }}
                                </td>
                            ...
                            <tr v-if="$page.props.sekolahs.length < 1">
                                <td
                                    colspan="3"
                                    class="p-2 flex itens-center justify-center"
                                >
                                    Belum ada sekolah
                                </td>
                            </tr>
