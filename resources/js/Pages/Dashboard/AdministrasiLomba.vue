...
const FormNilai = defineAsyncComponent(() =>
    import("@/Components/Lomba/FormNilai.vue")
);
    ...
    <Dash title="Administrasi Lomba">
        <Transition name="slide-fade">
            <div class="content relative w-full" v-if="mode == 'list'">
                <h1
                    class="text-center md:my-4 font-bold tracking-wider text-white drop-shadow text-3xl"
                >
                    <span> Adminstrasi Lomba <br /> </span>
                </h1>

                <div
                    class="w-full grid grid-cols-1 md:grid-cols-3 gap-3 items-start mt-8"
                >
                    <div
                        class="grid gap-3"
                        v-for="(cols, c) in bidangs"
                        :key="c"
                    >
                        <div
                        ...
                        >
                            <div
                                class="card-toolbar w-full flex items-center justify-between p-3 bg-teal-600 text-white"
                            >
                                <span>
                                    {{ bidang.label }}
                                </span>
                                <div class="toolbar-items flex items-center">
                                    <button
                                        ...
                                        class="btnChevron hover:border border-gray-50 rounded-full"
                                    >
                                        <SvgIcon
                                            type="mdi"
                            ...
                            <div
                                class="content card-content bg-white flex-col gap-2 hidden p-3 duration-500 transition-all"
                            >
                                <button
