...
<template>
    <div class="w-full bg-white rounded-lg overflow-hidden">
        ...
        <div
            class="toolbar w-full p-3 flex items-center justify-between shadow-lg print:hidden bg-white sticky z-50"
        >
            Kartu Panitia
        ...
        <div
            class="content w-full bg-gray-100 print:bg-transparent grid grid-cols-3 gap-3 py-3 px-10 print:p-0"
        >
            <div
            ...
            >
                ...
                <div class="content pt-2">
                    ...
                    <div
                        class="identitas p-4 pb-0 text-center mt-4 print:mt-2 inline-block"
                    >
                        <img
                            src="/img/peserta.png"
                            alt="Foto"
                            class="w-1/3 mx-auto rounded-full border-4 bg-teal-600 p-1"
                        />
                        <h1
                            class="text-[1vw] print:text-[.8rem] font-bold tracking-wide mt-2"
                        >
                    ...
                    <vue-qrcode
                        :value="`https://pentaspai.kkgpaiwagir.or.id/panpel/${p}`"
                        :options="{ width: 60 }"
                        class="mx-auto mt-6 print:mt-3"
                    />
                    <SvgIcon
                        :path="mdiTypewriter"
                        type="mdi"
