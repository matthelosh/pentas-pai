                ...
                >
                    ...
                    <div class="col-span-3">
                        ...
                        >
                            ...
                            />
                            <div class="logo--text">
                                <h3 class="my-0 leading-4 font-bold text-sm">
                                    PENTAS PAIS 2023
                                </h3>
                        ...
                        <vue-qrcode
                            ...
                            :options="{
                                width: 75,
                                color: { light: '#fefefeee', dark: '#347f67' },
                            }"
                ...
                <div v-for="(group, g) in items" :key="g">
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <h1
                                    class="text-uppercase whitespace-nowrap uppercase font-extrabold w-[100%] text-4xl print:text-2xl text-white"
                                    style="writing-mode: vertical-lr"
                                >
                                    {{ label }}
                                </h1>
                            ...
                            <div class="col-span-3">
                                ...
                                >
                                    ...
                                    <div class="logo--text">
                                        <h3
                                            class="my-0 leading-4 font-bold text-sm"
                                        >
                                            PENTAS PAIS 2023
                                        </h3>
                                        <h2 class="my-0 leading-4 text-xs">
        ...
        <div class="w-full h-[80vh] flex items-center justify-center" v-else>
            <div>
                <h1 class="text-2xl text-gray-800">
                    Tidak ada peserta pada bidang lomba {{ props.bidang.label }}
                </h1>
            </div>
        </div>
    </div>
