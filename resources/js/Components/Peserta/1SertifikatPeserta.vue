            ...
            <div class="content p-3 overflow-auto">
                ...
                <div
                    ...
                    style="
                        ...
                        padding: 20px;
                        height: 21.5cm;
                        background: url('/img/piagam-peserta.jpg');
                ...
                >
                    ...
                    <h1
                        style="font-family: Dancing Script !important"
                        class="text-6xl text-center mt-20"
                    >
                        Sertifikat
                    </h1>
                    <h2 class="text-center mt-6 text-xl">Diberikan Kepada:</h2>
                    <div
                        class="flex justify-center items-center w-10/12 mx-auto gap-4"
                    >
                        <img
                            :src="imgUrl(selectedPeserta.foto)"
                            alt="Foto"
                            class="aspect-square border-4 border-gray-800 rounded-full h-40 object-cover object-center"
                        />
                        <div class="bio">
                            <h1
                                class="nama text-[3.2rem] mt-4 capitalize"
                                style="
                                ...
                                "
                            >
                                {{ selectedPeserta.nama.toUpperCase() }}
                            </h1>
                            <h4 class="sekolah text-xl mt-4">
                                {{ selectedPeserta.sekolah.nama }}
                            </h4>
                            <h4 class="peringkat text-4xl mt-4">
                                Sebagai Peserta
                            </h4>
                        </div>
                    </div>
                    <p class="mt-4 mx-20 text-xl text-justify">
                        dalam perlombaan
                        ...
                        yang diselenggarakan oleh KKG PAI Kecamatan Wagir.
                        Semoga dapat menjadi motivasi di masa depan.
                    </p>
                    <div class="grid grid-cols-3 w-10/12 mx-auto">
                        <div class="relative">
                            <p class="text-center mt-14">
                                Ketua KKG PAI Kec. Wagir
                            </p>
                            <img
                                src="/img/stempel.png"
                                alt="Stempel"
                                class="absolute h-32 left-[10%] -translate-y-4 mix-blend-multiply"
                            />
                            <img
                                src="/img/ttd-kkg.png"
                                alt="Ketua"
                                class="left-[50%] h-16 mix-blend-multiply absolute -translate-x-8"
                            />
                            <p
                                class="text-center underline font-extrabold mt-14"
                            >
                                Hasan Lutfi, S.PdI., M. PdI.
                            </p>
                            <p class="text-center">
                                NIP. 19760115 200501 1 002
                            </p>
                        </div>
                        <div></div>
                        <div class="relative">
                            ...
                            <img
                                src="/img/ttd-ketua.png"
                                alt="Ketua"
                                class="left-[50%] h-20 mix-blend-multiply absolute -translate-x-10"
                            />
                            <p
                                class="text-center underline font-extrabold mt-14"
                            >
                                Choiri Machmudi, S. Ag., M. Pd.
                            </p>
                            <p class="text-center">
                                NIP. 19760115 200501 1 002
                            </p>
                    ...
                    <div class="absolute bottom-2 left-6 print:relative">
                        <vue-qrcode
                            :value="`https://pentaspai.kkgpaiwagir.or.id/verifikasi/sertifikat?id=${selectedPeserta.nisn}`"
                            :options="{ width: 75 }"
                            class="shadow"
                        />
                        <span class="text-teal-800 bg-white bg-opacity-50"
                            >https://pentaspais.kkgpaiwagir.or.id</span
                        >
                    </div>
                </div>
            </div>
